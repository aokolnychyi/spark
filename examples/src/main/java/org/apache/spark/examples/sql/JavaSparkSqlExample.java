...
public class JavaSparkSqlExample {
    ...
    private static void runDatasetCreationExample(SparkSession spark) {
        ...
        primitiveDS.map((MapFunction<Integer, Integer>) value -> value + 1, intEncoder).collect();
        // Returns [2, 3, 4]
    ...
    private static void runProgrammaticSchemaExample(SparkSession spark) {
        ...
        // Create an RDD
        JavaRDD<String> people = spark.read()
                .textFile("examples/src/main/resources/people.txt")
                .javaRDD();
        ...
        JavaRDD<Row> rowRDD = people.map((Function<String, Row>) record -> {
        ...
        results.javaRDD()
                .map((Function<Row, String>) row -> "Name: " + row.getString(0))
                .collect();
